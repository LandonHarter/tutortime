export default function RequestSVG({ className }: { className?: string }) {
    return (
        <svg fill="#000000" width="800px" height="800px" viewBox="0 0 16 16" id="request-sent-16px" xmlns="http://www.w3.org/2000/svg" className={className}>
